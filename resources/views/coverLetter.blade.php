...
@section('content')
    <section>
        ...
        <p>I dev, ops, test, doc, system design, problem solve, and when needs be can kick around a bit of frontend.  I like linux and the command line is my comfort zone.</p>
